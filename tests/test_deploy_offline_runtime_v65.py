...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v65.sh"
COMMIT = "fee2553535b23c1486e87cdf17ef807b564ebdaa"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v65-bundle.js").write_text("new panel\n")
        ...
        print("fee2553535b23c1486e87cdf17ef807b564ebdaa")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v65-*"))
