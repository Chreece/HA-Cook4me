...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v112.sh"
COMMIT = "d196e39bd676d5b991dd4ab653ebf1a478672eb2"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v112-bundle.js").write_text("new panel\n")
        ...
        print("d196e39bd676d5b991dd4ab653ebf1a478672eb2")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v112-*"))
        ...
        self.assertEqual(suites, ["test_price_fixes_v104.py", "test_entity_setup_v73.py", "test_device_announcements_v72.py", "test_announcement_fallback_v105.py", "test_cross_language_send_v106.py", "test_dietary_guidance_v107.py", "test_delivery_confirmation_v108.py", "test_weekly_summary_v109.py", "test_weekly_selection_v110.py", "test_product_capture_v78.py", "test_scanner_v111.py", "test_product_packages_v112.py"])
