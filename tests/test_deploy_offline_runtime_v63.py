...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v63.sh"
COMMIT = "f027f6c26008d737ec20741ab3a9b363c8f62468"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v63-bundle.js").write_text("new panel\n")
        ...
        print("f027f6c26008d737ec20741ab3a9b363c8f62468")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v63-*"))
