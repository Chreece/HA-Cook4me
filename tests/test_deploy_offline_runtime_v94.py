...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v94.sh"
COMMIT = "7d9250c2a0dee825e53949d2a073c2262d51d100"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v94-bundle.js").write_text("new panel\n")
        ...
        print("7d9250c2a0dee825e53949d2a073c2262d51d100")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v94-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 473 observations"), 2)
        ...
        self.assertEqual(suites, ["test_price_conversions_v94.py"])
