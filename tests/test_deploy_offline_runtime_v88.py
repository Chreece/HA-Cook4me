...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v88.sh"
COMMIT = "410cb3ed310f0351c9b260831911967996b3abd9"
...
if name == "git":
    if args[0] == "init":
        ...
        print("410cb3ed310f0351c9b260831911967996b3abd9")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v88-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 453 observations"), 2)
    ...
    def test_missing_offline_price_file_leaves_installation_untouched(self):
        for scenario in ("missing_prices", "missing_retail", "missing_density"):
