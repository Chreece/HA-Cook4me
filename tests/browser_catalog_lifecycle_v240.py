"""Actual catalog months, country boundaries and exact fruit-spread opening UI."""
...
from test_catalog_lifecycle_v240 import JAMS, NAMES, PANTRY, SEASONS, actual_choice, catalog, opening
...
def run():
    ...
    for ident, _, code, rule in JAMS:
        for barcode in (code, '4260248063908' if code == '4260248063892' else '4260248063892', '4067796111118'):
            lot = {'brand': 'Xucker' if barcode != '4067796111118' else 'dmBio', 'barcode': barcode}
    ...
    with sync_playwright() as p:
        ...
        for width, height in ((390, 844), (1440, 980)):
            ...
            expect(option('M_FOOD_398')).to_contain_text('Κολοκύθα Χοκάιντο')
            ...
            print(f'PASS {width}: twelve-month DE/GR filters, supermarket names, exact jam flavours and opening confirmation')
            page.close()
        browser.close()
