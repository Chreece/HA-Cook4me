...
class SemanticCatalogFullCorpusV60Tests(unittest.TestCase):
    ...
    def test_all_committed_review_files_are_consumed(self):
        # One base review file, ten Capture 3 language batches, and Phase 3 batches 001..097.
        self.assertEqual(len(self.paths), 108)
    ...
    def test_full_review_corpus_has_one_identity_per_exact_source_label(self):
        ...
        # exact Capture-3 rows.
        self.assertEqual(
            self.raw_review_items,
            123 + 9658 + 26 + 19 + 5 + 35 + 13 + 1 + 32 + 29 + 34 + 36,
        )
        self.assertEqual(self.payload["summary"]["reviewedSourceLabels"], 10011)
        self.assertEqual(len(self.payload["sourceIdentityToConcept"]), 10011)
        self.assertEqual(self.raw_review_items - 10011, 0)
