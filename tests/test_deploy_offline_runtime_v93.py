...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v93.sh"
COMMIT = "686c3fb1a8470d3ac6349eb0e38305930c69c90d"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v93-bundle.js").write_text("new panel\n")
        ...
        print("686c3fb1a8470d3ac6349eb0e38305930c69c90d")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v93-*"))
        ...
        self.assertEqual(suites, ["test_jobs_v93.py"])
