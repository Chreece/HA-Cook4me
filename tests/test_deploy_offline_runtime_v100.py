...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v100.sh"
COMMIT = "1d9874af7a808cacbd332a66555dfa117fdfd462"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v100-bundle.js").write_text("new panel\n")
        ...
        print("1d9874af7a808cacbd332a66555dfa117fdfd462")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v100-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 509 observations"), 2)
        ...
        self.assertEqual(suites, ["test_price_allowances_v99.py"])
