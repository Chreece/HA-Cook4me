...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v101.sh"
COMMIT = "f00f76b1fd494c6b3f05f5275034d19db2c62d2f"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v101-bundle.js").write_text("new panel\n")
        ...
        print("f00f76b1fd494c6b3f05f5275034d19db2c62d2f")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v101-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 514 observations"), 2)
        ...
        self.assertEqual(suites, ["test_price_expansion_v101.py"])
