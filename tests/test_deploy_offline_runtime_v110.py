...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v110.sh"
COMMIT = "e531b21563d8749e75e34c7970a20aeecf3d043d"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v110-bundle.js").write_text("new panel\n")
        ...
        print("e531b21563d8749e75e34c7970a20aeecf3d043d")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v110-*"))
        ...
        self.assertEqual(suites, ["test_price_fixes_v104.py", "test_entity_setup_v73.py", "test_device_announcements_v72.py", "test_announcement_fallback_v105.py", "test_cross_language_send_v106.py", "test_dietary_guidance_v107.py", "test_delivery_confirmation_v108.py", "test_weekly_summary_v109.py", "test_weekly_selection_v110.py"])
