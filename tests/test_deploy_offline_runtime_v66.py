...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v66.sh"
COMMIT = "76dbeaa5d113e402448abdeb979ef1076246e561"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v66-bundle.js").write_text("new panel\n")
        ...
        print("76dbeaa5d113e402448abdeb979ef1076246e561")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v66-*"))
