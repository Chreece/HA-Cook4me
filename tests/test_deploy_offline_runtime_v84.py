...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v84.sh"
COMMIT = "d88f73d0420b48bea075986b20d15a3cf274a8fd"
...
if name == "git":
    if args[0] == "init":
        ...
        print("d88f73d0420b48bea075986b20d15a3cf274a8fd")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v84-*"))
