...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v103.sh"
COMMIT = "04d4d5442e0c92d71fdbb71d6b0ccaae8eba2aea"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v103-bundle.js").write_text("new panel\n")
        ...
        print("04d4d5442e0c92d71fdbb71d6b0ccaae8eba2aea")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v103-*"))
        ...
        self.assertEqual(suites, ["test_price_expansion_v103.py"])
