...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v67.sh"
COMMIT = "67d2a0024f7024f904041fc731fc0ff2506f5bf9"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v67-bundle.js").write_text("new panel\n")
        ...
        print("67d2a0024f7024f904041fc731fc0ff2506f5bf9")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v67-*"))
