...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v73.sh"
COMMIT = "d164cb66ce191130a1676f0baf4f7dfadb34e997"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v73-bundle.js").write_text("new panel\n")
        ...
        print("d164cb66ce191130a1676f0baf4f7dfadb34e997")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v73-*"))
