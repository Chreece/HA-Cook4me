...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v102.sh"
COMMIT = "2f9d326a4c4f0feda3231e08f00335e8c7657d6d"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v102-bundle.js").write_text("new panel\n")
        ...
        print("2f9d326a4c4f0feda3231e08f00335e8c7657d6d")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v102-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 518 observations"), 2)
        ...
        self.assertEqual(suites, ["test_price_expansion_v102.py"])
