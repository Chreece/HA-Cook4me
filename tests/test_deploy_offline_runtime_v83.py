...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v83.sh"
COMMIT = "36b59795fab2708d74ad478b56939b935a055ad3"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v83-bundle.js").write_text("new panel\n")
        ...
        print("36b59795fab2708d74ad478b56939b935a055ad3")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v83-*"))
