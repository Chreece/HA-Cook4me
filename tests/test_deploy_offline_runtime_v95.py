...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v95.sh"
COMMIT = "354accf184f12ae387e8f191b8153bbeb9da82a0"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v95-bundle.js").write_text("new panel\n")
        ...
        print("354accf184f12ae387e8f191b8153bbeb9da82a0")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v95-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 493 observations"), 2)
        ...
        self.assertEqual(suites, ["test_price_expansion_v95.py"])
