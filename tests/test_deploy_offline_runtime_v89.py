...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v89.sh"
COMMIT = "82fb387a170a9beb9d53cf2b14187fec58e4014a"
...
if name == "git":
    if args[0] == "init":
        ...
        print("82fb387a170a9beb9d53cf2b14187fec58e4014a")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v89-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 464 observations"), 2)
