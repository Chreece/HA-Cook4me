...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v113.sh"
COMMIT = "6e49f88fb2e4d596d812210130da78bfe3161c40"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v113-bundle.js").write_text("new panel\n")
        ...
        print("6e49f88fb2e4d596d812210130da78bfe3161c40")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v113-*"))
