...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v82.sh"
COMMIT = "9b0aa5fce6734f71a9304cd72d64e9e0f3ae94be"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v82-bundle.js").write_text("new panel\n")
        ...
        print("9b0aa5fce6734f71a9304cd72d64e9e0f3ae94be")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v82-*"))
