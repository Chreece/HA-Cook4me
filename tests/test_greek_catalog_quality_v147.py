...
class GreekCatalogQualityV147Tests(unittest.TestCase):
    def test_v147_is_active_and_versioned(self):
        panel=PANEL.read_text(encoding="utf-8")
        manifest=MANIFEST.read_text(encoding="utf-8")
        ui=(FRONTEND/"cook4me-panel-v147.js").read_text(encoding="utf-8")
        self.assertIn("cook4me-recipe-hub-panel-v147",panel)
        self.assertIn("cook4me-panel-v147.js",panel)
        self.assertIn("/cook4me_static/2026.9.21.12",panel)
        self.assertIn("?v=2026.9.21.12",panel)
        self.assertIn('"version": "2026.9.21.12"',manifest)
        self.assertIn(
            "if(!customElements.get(V146))await import('./cook4me-panel-v146.js?v=2026.9.21.11')",
            ui,
        )

    def test_quality_overlay_complements_curated_v146_terms(self):
        p=presentation_module()
        labels=p.labels()["el"]
        # v146 curated terminology remains intact.
        ...
        # v147 fills audited gaps / awkward remaining terms.
        expected={
