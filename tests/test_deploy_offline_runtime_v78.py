...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v78.sh"
COMMIT = "0b0e3fcd0c8fd00b38d6b8fd5a0b63b6fb2f2138"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v78-bundle.js").write_text("new panel\n")
        ...
        print("0b0e3fcd0c8fd00b38d6b8fd5a0b63b6fb2f2138")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v78-*"))
