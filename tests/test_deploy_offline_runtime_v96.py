...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v96.sh"
COMMIT = "8ca9a66792b4ec90e42ec5bf8007f2e3c7b07358"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v96-bundle.js").write_text("new panel\n")
        ...
        print("8ca9a66792b4ec90e42ec5bf8007f2e3c7b07358")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v96-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 504 observations"), 2)
        ...
        self.assertEqual(suites, ["test_price_expansion_v96.py"])
