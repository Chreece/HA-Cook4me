...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v75.sh"
COMMIT = "172f8bb16aea5b5b0a641d878314b4e6f6d5e3f8"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v74-bundle.js").write_text("new panel\n")
        ...
        print("172f8bb16aea5b5b0a641d878314b4e6f6d5e3f8")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v75-*"))
