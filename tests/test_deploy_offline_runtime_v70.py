...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v70.sh"
COMMIT = "e6fd14c71546367224dffca5a0515c1e37f268c2"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v70-bundle.js").write_text("new panel\n")
        ...
        print("e6fd14c71546367224dffca5a0515c1e37f268c2")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v70-*"))
