...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v76.sh"
COMMIT = "d17bc0c8627831c7ae5c4e54f098b3e8d13242dd"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v76-bundle.js").write_text("new panel\n")
        ...
        print("d17bc0c8627831c7ae5c4e54f098b3e8d13242dd")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v76-*"))
