...
class V41UIContractTests(unittest.TestCase):
    ...
    def test_v60_is_active_server_seeded_and_cache_busted(self):
        ...
        v59 = V59.read_text(encoding="utf-8")
        self.assertIn('import "./cook4me-panel-v58.js"', v59)
        self.assertIn('cook4me/v30/ui_seed', v59)
        self.assertIn('cook4me.ui.shell.v2.', v59)
        active = V60.read_text(encoding="utf-8")
        self.assertIn('import "./cook4me-panel-v59.js"', active)
        self.assertIn('cook4me/v31/scale_state', active)
