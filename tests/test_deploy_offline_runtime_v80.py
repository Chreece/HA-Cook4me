...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v80.sh"
COMMIT = "7cb8f74f786f112e9c67fd109f1d83102a1424c5"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v80-bundle.js").write_text("new panel\n")
        ...
        print("7cb8f74f786f112e9c67fd109f1d83102a1424c5")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v80-*"))
