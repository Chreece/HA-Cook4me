...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v105.sh"
COMMIT = "cdd8545f9b9bfe9a9c292a9021e62c21733694f4"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v105-bundle.js").write_text("new panel\n")
        ...
        print("cdd8545f9b9bfe9a9c292a9021e62c21733694f4")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v105-*"))
        ...
        self.assertEqual(suites, ["test_price_fixes_v104.py", "test_entity_setup_v73.py", "test_device_announcements_v72.py", "test_announcement_fallback_v105.py"])
