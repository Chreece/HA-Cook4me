...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v87.sh"
COMMIT = "439b8453144fa59de42b0230a47edf4908a0d167"
...
if name == "git":
    if args[0] == "init":
        ...
        print("439b8453144fa59de42b0230a47edf4908a0d167")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v87-*"))
        ...
        self.assertEqual(result.stdout.count("Offline price snapshot: 405 observations"), 2)
