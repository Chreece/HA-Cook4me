...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v98.sh"
COMMIT = "8216d20ffb6f5a5118196b85dee8b3d88652552b"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v98-bundle.js").write_text("new panel\n")
        ...
        print("8216d20ffb6f5a5118196b85dee8b3d88652552b")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v98-*"))
        ...
        self.assertEqual(suites, ["test_today_state_v98.py"])
