...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v81.sh"
COMMIT = "feaf043f429b812221db4d2c5a5033519b5f9c11"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v81-bundle.js").write_text("new panel\n")
        ...
        print("feaf043f429b812221db4d2c5a5033519b5f9c11")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v81-*"))
