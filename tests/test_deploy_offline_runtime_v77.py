...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v77.sh"
COMMIT = "5cf5e00c55254c9d8260d6b6de5a9600afa8dc61"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v77-bundle.js").write_text("new panel\n")
        ...
        print("5cf5e00c55254c9d8260d6b6de5a9600afa8dc61")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v77-*"))
