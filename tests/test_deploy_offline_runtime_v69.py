...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v69.sh"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v69-bundle.js").write_text("new panel\n")
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v69-*"))
