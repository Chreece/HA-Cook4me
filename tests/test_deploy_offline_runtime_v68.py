...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v68.sh"
COMMIT = "d7cfbdaeef4273ff758ff3aa96abac09dda75fd7"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v68-bundle.js").write_text("new panel\n")
        ...
        print("d7cfbdaeef4273ff758ff3aa96abac09dda75fd7")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v68-*"))
