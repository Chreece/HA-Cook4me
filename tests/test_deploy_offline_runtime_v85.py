...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v85.sh"
COMMIT = "7fb8a9558c9ce5f4c25139cde6a3f5d6f2ddcdb5"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v84-bundle.js").write_text("new panel\n")
        ...
        print("7fb8a9558c9ce5f4c25139cde6a3f5d6f2ddcdb5")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v85-*"))
