...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v104.sh"
COMMIT = "8ac03804b7b28124af13e428d208f4feaa0550a9"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v104-bundle.js").write_text("new panel\n")
        ...
        print("8ac03804b7b28124af13e428d208f4feaa0550a9")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v104-*"))
        ...
        self.assertEqual(suites, ["test_price_fixes_v104.py", "test_entity_setup_v73.py", "test_device_announcements_v72.py"])
    ...
    def test_missing_offline_price_file_leaves_installation_untouched(self):
        for scenario in ("missing_prices", "missing_retail", "missing_density", "missing_reference_portions", "missing_benchmarks", "missing_allowances"):
