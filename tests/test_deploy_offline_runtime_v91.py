...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v91.sh"
COMMIT = "1d99fec620cbea433841f9c8a4e23e9539b31b10"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v91-bundle.js").write_text("new panel\n")
        ...
        print("1d99fec620cbea433841f9c8a4e23e9539b31b10")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v91-*"))
