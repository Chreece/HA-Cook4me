...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v99.sh"
COMMIT = "7c474c8c3d01bbba51cd25d0fa68d559f6088c22"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v99-bundle.js").write_text("new panel\n")
        ...
        print("7c474c8c3d01bbba51cd25d0fa68d559f6088c22")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v99-*"))
