...
assert.equal(panel.getAttribute("data-cook4me-build"),({64:"2026.9.15.6",65:"2026.9.15.7",66:"2026.9.15.8",67:"2026.9.15.9",68:"2026.9.15.10",69:"2026.9.15.11"})[version]);
assert.equal(panel.shadowRoot.querySelector("#cook4meLoadStatus")?.textContent||"","");
