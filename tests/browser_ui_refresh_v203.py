...
with sync_playwright() as p:
    ...
    for width,height in sizes:
        ...
        page.evaluate("""(()=>{app._v116Scale=structuredClone(app._fixtureScale);const content=app.shadowRoot.getElementById('content'),section=app._v117EnsureScalePane(content);app._v116Card(section);})()""")
