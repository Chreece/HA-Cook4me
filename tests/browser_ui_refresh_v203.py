...
with sync_playwright() as p:
    ...
    for width,height in sizes:
        ...
        page.evaluate("""(()=>{app.shadowRoot.querySelector('[data-v218-scale-probe]')?.remove();app.shadowRoot.querySelector('[data-v218-nutrition-probe]')?.remove();app._nutritionSettings=structuredClone(app._fixtureNutrition);const probe=document.createElement('section');probe.dataset.v218NutritionProbe='';probe.innerHTML=app._nutritionSettingsHtml();app.shadowRoot.append(probe);app._bindNutritionSettings(probe);})()""")
