...
with sync_playwright() as p:
    ...
    for width,height in sizes:
        ...
        page.evaluate("""(()=>{app._v116Scale=structuredClone(app._fixtureScale);const section=app.shadowRoot.querySelector('[data-v78-section="scale"]');if(!section)throw new Error('scale test section missing');app._v116Card(section);})()""")
        page.wait_for_function("app.shadowRoot.querySelector('[data-v117-container] [data-v117-use]')")
        page.locator('[data-v117-container] [data-v117-use]').click()
        check(page,"app._v117ActiveContainerId==='jar-1'&&app.shadowRoot.querySelector('[data-v117-container] [data-v117-use]').textContent.includes('Ακύρωση χρήσης')",prefix+'container Use changes to Unuse when active')
        page.locator('[data-v117-container] [data-v117-use]').click()
        check(page,"app._v117ActiveContainerId===''&&app._v116SoftwareTare===0&&app.shadowRoot.querySelector('[data-v117-container] [data-v117-use]').textContent.includes('Χρήση')",prefix+'container Unuse restores unused state')
