...
with sync_playwright() as p:
    ...
    for width,height in sizes:
        ...
        page.evaluate("app.shadowRoot.querySelector('[data-v218-scale-probe]')?.remove();app._nutritionSettings=structuredClone(app._fixtureNutrition);app._renderTab()")
        page.locator('[data-v78-pane=integration]').click()
        page.wait_for_function("app.shadowRoot.querySelector('[data-v218-unresolved]')")
