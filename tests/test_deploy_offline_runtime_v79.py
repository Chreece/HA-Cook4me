...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v79.sh"
COMMIT = "c7096d7e3824cf1a998e07fffe95dff057d29c51"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v79-bundle.js").write_text("new panel\n")
        ...
        print("c7096d7e3824cf1a998e07fffe95dff057d29c51")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v79-*"))
