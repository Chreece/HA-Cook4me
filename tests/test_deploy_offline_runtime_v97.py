...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v97.sh"
COMMIT = "9769e3b204e1be36f54178fe91aa8a57ac4c64be"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v97-bundle.js").write_text("new panel\n")
        ...
        print("9769e3b204e1be36f54178fe91aa8a57ac4c64be")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v97-*"))
        ...
        self.assertEqual(suites, ["test_price_expansion_v97.py"])
