...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v108.sh"
COMMIT = "8e4fdd9356da85fdfeb8a8509147b3d196d475c3"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v108-bundle.js").write_text("new panel\n")
        ...
        print("8e4fdd9356da85fdfeb8a8509147b3d196d475c3")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v108-*"))
        ...
        self.assertEqual(suites, ["test_price_fixes_v104.py", "test_entity_setup_v73.py", "test_device_announcements_v72.py", "test_announcement_fallback_v105.py", "test_cross_language_send_v106.py", "test_dietary_guidance_v107.py", "test_delivery_confirmation_v108.py"])
