...
SCRIPT = Path(__file__).resolve().parents[1] / "tools/deploy_offline_runtime_v106.sh"
COMMIT = "dd8c369d0eae3bcd287631b25fc228bbfd162a43"
...
if name == "git":
    if args[0] == "init":
        ...
        (staged / "frontend/cook4me-panel-v106-bundle.js").write_text("new panel\n")
        ...
        print("dd8c369d0eae3bcd287631b25fc228bbfd162a43")
elif name == "docker":
    if args[0] == "inspect":
...
class DeploymentTests(unittest.TestCase):
    ...
    def test_success_keeps_backup_and_installs_pinned_complete_component(self):
        ...
        runs = list((root / "config/.cook4me-deploy").glob("v106-*"))
        ...
        self.assertEqual(suites, ["test_price_fixes_v104.py", "test_entity_setup_v73.py", "test_device_announcements_v72.py", "test_announcement_fallback_v105.py", "test_cross_language_send_v106.py"])
