...
class Cook4MeRecipeHubPanelV44 extends BasePanel{
  ...
  _renderWeek(c){
    ...
    <section class="card" style="margin-top:12px"><h3>${this._escape(this._t("leftovers"))}</h3>${this._leftoversHtml()}</section><section class="card" style="margin-top:12px" data-week-summary><h3>${this._escape(this._t("nutritionDashboard"))}</h3>${this._dashboardHtml()}</section>
