...
function evidenceUrl(value){
 try{const url=new URL(value);return url.protocol==='https:'&&!url.username&&!url.password&&!url.port&&['www.dm.de','www.aldi-sued.de','www.knuspr.de','asia4friends.de','www.piccantino.de','www.greenist.de','www.der-ludwig.de','www.send-a-fish.de','www.naturata-shop.de','shop.vanillekiste.de','www.bwb.de','www.fao.org','fdc.nal.usda.gov','www.nist.gov'].includes(url.hostname)?url:null;}catch{return null;}
}
