// Generated by tools/build_frontend_bundle_v66.py; edit the source layers.
const activeElement="cook4me-recipe-hub-panel-v66";
const scope=name=>name===activeElement?name:`${name}-build-202609158`;
