...
:host(.ui203) details.ui203-more{display:block;flex:1 1 190px;min-width:min(100%,190px);margin:0!important;padding:0!important;border:0!important;background:transparent!important;border-radius:12px;overflow:hidden}
...
:host(.ui203) details.ui203-more[open]{flex-basis:190px;padding:5px!important;border:1px solid var(--ui203-line)!important;background:var(--ui203-raised)!important;box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--ui203-accent) 8%,transparent)}
