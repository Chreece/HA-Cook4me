// Generated by tools/build_frontend_bundle_v69.py; edit the source layers.
const activeElement="cook4me-recipe-hub-panel-v69";
const scope=name=>name===activeElement?name:`${name}-build-2026091511`;
