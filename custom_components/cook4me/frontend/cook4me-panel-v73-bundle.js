// Generated by tools/build_frontend_bundle_v73.py; edit the source layers.
const activeElement="cook4me-recipe-hub-panel-v73";
const scope=name=>name===activeElement?name:`${name}-build-2026091515`;
