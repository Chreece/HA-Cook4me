...
class Cook4MeRecipeHubPanelV180 extends BasePanel{
 ...
 _renderTab(){
  ...
  this.setAttribute('data-cook4me-ui-revision','208');
  this._v180Styles();
  return result;
 }
 _v180Styles(){
