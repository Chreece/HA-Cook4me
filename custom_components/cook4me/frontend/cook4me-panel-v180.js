...
const BasePanel=WeeklyProgressMixin(ViewFiltersMixin(ReceiptLauncherMixin(RecipeCoverageMixin(ProductEditorMixin(ReceiptScannerMixin(ScannerSuggestionsMixin(customElements.get(V179))))))));
...
class Cook4MeRecipeHubPanelV180 extends BasePanel{
 ...
 _renderTab(){
  ...
  this.setAttribute('data-cook4me-ui-revision','200');
  this._v180Styles();
  return result;
 }
 _v180Styles(){
