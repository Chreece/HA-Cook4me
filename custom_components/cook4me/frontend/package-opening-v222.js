...
const TEXT={
 en:{title:'After opening',days:'Use within days after opening (package label)',catalog:'Catalog guidance',manual:'Enter the package instructions manually',apply:'Apply the opening deadline as the expiry date',opened:'Package opened',date:'Opened on',printed:'Printed expiry date',expiry:'Expiry date',confirm:'I follow these storage instructions',fridge:'Keep refrigerated at or below',unknown:'No matching opening window in the catalog. Enter the days stated on the package.',loading:'Checking catalog opening guidance…',failed:'Catalog guidance could not be loaded. You can enter the package instructions manually.',label:'The package instructions take priority.',choose:'Choose guidance',select:'Select the package actually used.',range:'days'},
 de:{title:'Nach dem Öffnen',days:'Nach dem Öffnen innerhalb von Tagen verbrauchen (Packungsangabe)',catalog:'Kataloghinweis',manual:'Packungsangabe manuell eingeben',apply:'Öffnungsfrist als Ablaufdatum anwenden',opened:'Packung geöffnet',date:'Geöffnet am',printed:'Aufgedrucktes Ablaufdatum',expiry:'Ablaufdatum',confirm:'Ich halte diese Lagerhinweise ein',fridge:'Gekühlt lagern bei höchstens',unknown:'Keine passende Öffnungsfrist im Katalog. Die Tage von der Packung eingeben.',loading:'Öffnungshinweise im Katalog werden geprüft…',failed:'Kataloghinweise konnten nicht geladen werden. Die Packungsangabe kann manuell eingegeben werden.',label:'Die Packungsangabe hat Vorrang.',choose:'Hinweis auswählen',select:'Die tatsächlich verwendete Packung auswählen.',range:'Tage'},
 el:{title:'Μετά το άνοιγμα',days:'Κατανάλωση εντός ημερών μετά το άνοιγμα (ετικέτα)',catalog:'Οδηγία καταλόγου',manual:'Χειροκίνητη εισαγωγή της οδηγίας συσκευασίας',apply:'Εφαρμογή της προθεσμίας ανοίγματος ως ημερομηνίας λήξης',opened:'Η συσκευασία ανοίχτηκε',date:'Ημερομηνία ανοίγματος',printed:'Αναγραφόμενη ημερομηνία λήξης',expiry:'Ημερομηνία λήξης',confirm:'Τηρώ αυτές τις οδηγίες συντήρησης',fridge:'Διατήρηση στο ψυγείο έως',unknown:'Δεν υπάρχει αντίστοιχη προθεσμία στον κατάλογο. Συμπλήρωσε τις ημέρες που αναγράφονται στη συσκευασία.',loading:'Έλεγχος οδηγιών ανοίγματος στον κατάλογο…',failed:'Οι οδηγίες καταλόγου δεν φορτώθηκαν. Μπορείς να συμπληρώσεις την οδηγία της συσκευασίας χειροκίνητα.',label:'Προτεραιότητα έχουν οι οδηγίες της συσκευασίας.',choose:'Επιλογή οδηγίας',select:'Επίλεξε τη συσκευασία που χρησιμοποιήθηκε.',range:'ημέρες'}
};
const CONDITIONS={
...
export const PackageOpeningMixin=Base=>class extends Base{
 ...
 _v222Conditions(rule){const index={en:0,de:1,el:2}[this._v222Lang()]||0;return [`${this._v222Text('fridge')} ${rule.maxTemperatureC} °C`,...(rule.conditions||[]).map(key=>CONDITIONS[key]?.[index]||key)].join(' · ');}
