// Generated by tools/build_frontend_bundle_v65.py; edit the source layers.
const activeElement="cook4me-recipe-hub-panel-v65";
const scope=name=>name===activeElement?name:`${name}-build-202609157`;
