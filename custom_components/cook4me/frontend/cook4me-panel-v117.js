...
class Cook4MeRecipeHubPanelV117 extends BasePanel{
 ...
 _v116Card(content){
  ...
  card.querySelectorAll('[data-v117-container]').forEach(node=>{
   ...
   node.querySelector('[data-use]').onclick=()=>{const active=this._v117ActiveContainerId===id;if(active){this._v116SoftwareTare=0;this._v117ActiveContainerId='';}else{this._v116SoftwareTare=Number(row.tareGrams||0);this._v117ActiveContainerId=id;}this._v116Card(section);this._v116Live();this._message(this._v117Text(active?'unused':'using'));};
