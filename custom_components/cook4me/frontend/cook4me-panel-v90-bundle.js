// Generated by tools/build_frontend_bundle_v90.py; edit the source layers.
const activeElement="cook4me-recipe-hub-panel-v90";
const scope=name=>name===activeElement?name:`${name}-build-2026091614`;
