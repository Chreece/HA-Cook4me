...
def main():
    ...
    if a.command=='search-recipes': dump(c4m.search_recipes(cfg,c4m.load_json(TOKENS),a.query,a.page,a.size,not a.no_details,a.max_details,a.country,a.language,a.app_version)); return
    if a.command=='test':
