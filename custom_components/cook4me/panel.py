...
_URL_BASE = "/cook4me_static/2026.9.22.7/runtime-v222"
_PANEL_ELEMENT = "cook4me-recipe-hub-panel-v180-runtime-v222"
...
async def async_register_panel(hass: HomeAssistant) -> None:
    ...
    await panel_custom.async_register_panel(
        ...
        module_url=f"{_URL_BASE}/{_PANEL_MODULE}?v=2026.9.22.7&scanner=194&receipt=195&editor=196&runtime=222",
