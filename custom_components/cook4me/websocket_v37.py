...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/scale_state",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/scale_select",
        vol.Optional("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/container_save",
        vol.Optional("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/container_delete",
        vol.Optional("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/measurement_record",
        vol.Optional("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/batch_weight_set",
        vol.Optional("entry_id"): str,
        vol.Required("recipe"): dict,
        vol.Required("grams"): vol.Any(int, float, str),
    }
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/session_clear",
        vol.Optional("entry_id"): str,
        vol.Required("recipe"): dict,
    }
)
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/recipe_scale",
        vol.Optional("entry_id"): str,
        vol.Required("recipe"): dict,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/portion_nutrition",
        vol.Optional("entry_id"): str,
        vol.Required("recipe"): dict,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/inventory_reweigh",
        vol.Optional("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/leftover_weight_set",
        vol.Optional("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "cook4me/v37/leftover_consume_weight",
        vol.Optional("entry_id"): str,
        vol.Required("leftover_id"): str,
        vol.Required("grams"): vol.Any(int, float, str),
    }
