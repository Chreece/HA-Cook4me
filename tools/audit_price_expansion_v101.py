#!/usr/bin/env python3
"""Compare reference, rough-budget and zero-allowance coverage with v100."""
import argparse
...
BASE = '1e1ca9937322da3c9c824f24cf5955e57292b93f'
...
if __name__ == '__main__':
    ...
    if args.before_json:
        ...
        with tempfile.TemporaryDirectory(prefix='cook4me-prices-v101-') as directory:
            archive = subprocess.check_output(['git', 'archive', BASE, 'custom_components/cook4me'], cwd=COMPONENT.parents[1])
            with tarfile.open(fileobj=io.BytesIO(archive)) as tar:
                tar.extractall(directory, filter='data')
            before = audit(Path(directory) / 'custom_components/cook4me', '_prices101_before')
    after = audit(COMPONENT, '_prices101_after')
